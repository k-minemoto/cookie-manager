...
/**
 * Implementation of the {@link AbstractCookieAttributeImpl} for Cookie value.
 * <p>
 * CookieのValue値用の実装です。
 * </p>
 * 
 ...
 * 
 */
public class NameAttribute extends AbstractCookieAttributeImpl {

	public NameAttribute(CookieAttribute nextAttr) {
		super(nextAttr);
	}

	@Override
	protected String writeAttribute(Cookie seed, CookieFormatter formatter) {
		return seed.getName() + "=" + formatter.format(seed.getValue());
	}
