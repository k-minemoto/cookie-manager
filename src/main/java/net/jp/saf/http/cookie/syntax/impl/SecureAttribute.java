...
/**
 * Implementation of the {@link AbstractCookieAttributeImpl} for 'Secure' attribute.
 * <p>
 * Secure属性用の実装です。
 * </p>
 * 
 ...
 * 
 */
public class SecureAttribute extends AbstractCookieAttributeImpl {

	public SecureAttribute(CookieAttribute nextAttr) {
		super(nextAttr);
	}
	...
	protected String writeAttribute(Cookie seed, CookieFormatter formatter) {
		return seed.getSecure() ? "; Secure" : EMPTY;
	}
